            ...
            <div className="mt-8 w-full">
              ...
              <div className="grid grid-cols-2 gap-2 max-h-40 overflow-y-auto pr-1 custom-scrollbar">
                <button
                  ...
                  className={`px-3 py-2 rounded-lg text-xs font-medium text-left transition-all border relative overflow-hidden ${
                    selectedLocation === 'Auto'
                      ? 'bg-brand-50 dark:bg-brand-500/20 border-brand-500 text-brand-700 dark:text-brand-400'
